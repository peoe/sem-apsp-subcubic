...
\begin{frame}{Proof of Lemma~\ref{lem:dom_pairs}\footnote[1]{\cite[Lemma~2.1]{Chan2007}}}
        ...
        \uncover<18->{
            ...
            \begin{align*}
                ...
                \uncover<19->{
                     ...
                     \uncover<20->{
                         &\overset{(A)}{\leq} \tilde{c} N^{1 + \varepsilon} - \tilde{c} N - \frac{\tilde{c}}{b} N + cN \overset{(B)}{\leq} \tilde{c} \left( N^{1 + \varepsilon} - N \right),
                     }
                }
            \end{align*}
        }
    ...
    \only<21>{
        If $(A)$: $\begin{aligned}1 = \frac{2}{2^{1 + \varepsilon}} + \frac{1}{b^{1 + \varepsilon}}\end{aligned}$, and $(B)$: $c \leq \frac{\tilde{c}}{b}$ are fulfilled:
        \[
            T'(N) \overset{(A)}{\leq} \tilde{c} N^{1 + \varepsilon} - \tilde{c} N - \frac{\tilde{c}}{b} N + cN \overset{(B)}{=} \tilde{c} \left( N^{1 + \varepsilon} - N \right),
        \]
    }
    \only<22>{
        In $(A)$ we get:
...
\begin{frame}{Proof of Theorem~\ref{thm:mat_mul}\footnote[1]{\cite[Theorem~3.2]{Chan2007}}}
    ...
    \only<3-6>{
        We split our matrices $A$ and $B$ into $\begin{aligned}\frac{n}{d}\end{aligned}$ blocks, that is $\begin{aligned}\forall i = 1, \dots, \frac{n}{d}: A_i \in \mathbb{R}^{n \times d}, B_i \in \mathbb{R}^{d \times n}\end{aligned}$ for some fixed $d$.
    ...
    \only<7->{
        ...
        \uncover<8->{
            ...
            \begin{itemize}
                ...
                \item<9-> $C^n$ grows grows exponentially.
            \end{itemize}
        }
