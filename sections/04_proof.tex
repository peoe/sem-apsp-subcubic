...
\begin{frame}{Proof of Lemma~\ref{lem:dom_pairs}\footnote[1]{\cite[Lemma~2.1]{Chan2007}}}
    ...
    \only<11-15>{
        ...
        \only<12-13>{
            ...
            $(C)$: Time to split current point set about the median.\footnote[3]{\cite[Section~2.3.2]{Preparata1985}}
...
\begin{frame}{Proof of Lemma~\ref{lem:sub_mat_mul}\footnote[1]{\cite[Lemma~3.1]{Chan2007}}}
    \only<1>{
        ...
        \end{lemma}
        % TODO: add remark about how we break ties in such a case!
    }
    \only<2-4>{
    ...
    % TODO: add note on breaking ties to retrieve the shortest path after we have computed its length!
\end{frame}
